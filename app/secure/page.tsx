              ...
              {activeTab === 'encode' ? (
                <div className='space-y-6'>
                  ...
                  <div>
                    ...
                    <input
                      className='w-full bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all'
                      id='encode-password'
