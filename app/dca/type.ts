export interface DcaTokenConfig {
  ...
  ratioPriceUp: number // Percentage increase in price to trigger additional investment
  priceBuyHistory: string
  tokenInput: string
  amountBuyPriceUp?: number
  maxAmountPriceUp: number
  amountBuyPriceDown?: number
